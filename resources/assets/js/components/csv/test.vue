    ...
    methods: {
        ...
        download() {
            ...
            for (let i = 0; i < this.Scheduled.length; i++) {
                ...
                doc.text(200, 110, 'Special Instructions:: ' + element['speciial_instruction'], null, null, 'right');
                // doc.text(105, 80, 'Client Details :', null, null, 'center');

                doc.text(0, 130, 'Product Description');
                doc.text(85, 130, 'Weight', null, null, 'center');
                doc.text(140, 130, 'Price', null, null, 'right');
                ...
                doc.text(0, 160, 'Authorizer Signature____________________________');
                doc.text(200, 160, 'Customer Signature____________________________', null, null, 'right');
                doc.addPage()
            }
