                          ...
                          <v-layout row wrap>
                            <v-flex xs8 sm8>
                              <v-form ref="form" @submit.prevent="submit">
                                ...
                                <v-select
                                :items="AllShipments"
                                v-model="addToContainer.selected"
                                label="Select"
                                item-text="client_email"
                                item-value="id"
                                multiple
                                chips
                                max-height="auto"
  ...
  AddContainer, EditContainer, 'barcode': VueBarcode
    ...
    data () {
      ...
      return {
       ...
       { text: 'Assigned Staff', value: 'assign_staff' },
       { text: 'Derivery Date', value: 'derivery_date' },
       { text: 'Derivery Time', value: 'derivery_time' },
       { text: 'Status', value: 'status' },
