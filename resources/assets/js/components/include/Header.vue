          ...
          <template>
            <v-card>
              ...
              <router-link
                ...
                v-for="roleR in user.roles"
                :key="roleR.id"
                v-if="roleR.name === 'Rider'"
              >
                <div class="v-list__tile__action">
              ...
              <router-link
                to="/subscribers"
                class="v-list__tile v-list__tile--link"
                v-if="user.can['view subscribers']"
              >
                <div class="v-list__tile__action">
              ...
              <v-list-group prepend-icon="book" v-if="user.can['outscan', 'inscan']">
                ...
                <router-link
                  to="/scanner"
                  class="v-list__tile theme--light"
              ...
              <v-list-group
                ...
                v-for="roleQ in user.roles"
                :key="roleQ.id"
                v-if="roleQ.name === 'Admin'"
              >
                <v-list-tile slot="activator">
