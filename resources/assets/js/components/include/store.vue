                  ...
                  <v-form ref="form" @submit.prevent="submit">
                    <v-container grid-list-xl fluid>
                      <v-layout wrap>
                        ...
                        <v-flex xs4 sm3>
                          <v-text-field
                          v-model="editedItem.receiver_email"
                          :rules="emailRules"
                          color="blue darken-2"
                        ...
                        <v-flex xs4 sm3>
                          <v-text-field
                          v-model="editedItem.receiver_phone"
                          :rules="rules.name"
                          color="blue darken-2"
                        ...
                        <v-flex xs4 sm3>
                          <v-text-field
                          v-model="editedItem.assign_staff"
                          :rules="rules.name"
                          color="blue darken-2"
                        ...
                        <v-flex xs4 sm3>
                          <v-text-field
                          v-model="editedItem.airway_bill_no"
                          :rules="rules.name"
                          color="blue darken-2"
                          label="Zip Code"
                          required
                        ...
                        <v-flex xs4 sm3>
                          <v-text-field
                          v-model="editedItem.shipment_type"
                          :rules="rules.name"
                          color="blue darken-2"
                          label="Shipment Type"
                          required
                        ...
                        <v-flex xs6 sm3 md3>
                          ...
                          ref="dialog1"
                          v-model="dmodal1"
                          :return-value.sync="editedItem.booking_date"
                          persistent
                          lazy
                          full-width
                          width="290px"
                      ...
                      <v-flex xs6 sm3 md3>
                        ...
                        ref="dialog2"
                        v-model="dmodal2"
                        :return-value.sync="editedItem.derivery_date"
                        persistent
                        lazy
                        full-width
                        width="290px"
                        ...
                        <v-text-field
                        slot="activator"
                        v-model="editedItem.derivery_date"
                        label="Derivery Date"
                        prepend-icon="event"
                        readonly
                        ></v-text-field>
                    ...
                    <v-flex xs4 sm3>
                      <v-text-field
                      v-model="editedItem.derivery_time"
                      :rules="rules.name"
                      :type="'time'"
                      color="blue darken-2"
                      label="Derivery Time"
...
export default {
   ...
   data () {
     ...
     return {
      ...
      { text: 'Client', value: 'receiver_name' },
      { text: 'From', value: 'sender_name' },
      { text: 'To', value: 'receiver_city' },
